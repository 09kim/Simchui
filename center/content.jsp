		...
		<article>
			...
			<table id="notice">
				<tr>
					...
					<th class="tdate" style="font-size: 80%;">작성시간: <%=sdf.format(bb.getDate())%></th>
					<th class="tread">조회수: <%=bb.getReadcount()%></th>
				</tr>
				<%
					// 5단계 while 다음행 이동 num,subject,name,date,readcount 열 가져오기
				%>
				<tr>
					<td class="left" colspan="5"><%=bb.getContent()%><br><br></td>
	...
	bb2 = boardList.get(i);%>
			...
			<div id="page_control">
				<%
					// 페이지수 구하기
				%>
				<input type="button" class="btn" value="목록" onclick="location.href = 'notice.jsp'">
			</div>
		</article>
		<!-- 게시판 -->
		<!-- 본문들어가는 곳 -->
